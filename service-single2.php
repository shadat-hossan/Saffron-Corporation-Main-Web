    ...
    <div class="technological_services_area">
      <div class="technological_services center_content">
        <div class="section_title" data-aos="fade-up">
            <h4>Document Management with Cutting-Edge Scanning and Archive Solutions</h4>
        </div>
        <div class="two_column_area flex-wrap">
          <div class="colum_info w-100" data-aos="fade-right">
            <p>We recognize one size does not fit all. That is why we use a variety of cutting-edge scanners that are evolved to specific needs. We offer the resource to digitize your data with exceptional accuracy, from the precision of robotic scanners to the high-volume capabilities of production scanners and the precise detail recorded by 3D scanners.</p>

            <h5>Elevate Your Data With OCR/ICR from Saffron Corporation</h5>
...
Experience the power of turning images into intelligible, actionable data with us</p>
    ...
    <div class="data_pipeline_area">
      <div class="data_pipeline_box center_content">
        <div class="section_title" data-aos="fade-right">
            <h2>Data Science Pipeline</h2>
        </div>
        <div class="data_pipeline_slider owl-carousel">
          <div class="data_pipeline_col" data-aos="fade-right">
            <div class="data_pipeline_icon">
              <div class="data_pipeline_icon_bg">
                <i class="fa fa-american-sign-language-interpreting" aria-hidden="true"></i>
              </div>
            </div>
            <div class="data_pipeline_info">
              <h6>ETL (Hadoop,Spark,Azure DF,MS SSIS,AWS Glue)</h6>
              <ul>
                <li>-Collect data form distributed sources.</li>
                <li>-Processing and formatting data for ease of use</li>
                <li>-Data cleansing </li>
              </ul>
              <a class="red-button" href="#">Data Acquisitions</a>
            </div>
          </div>

          <div class="data_pipeline_col data_pipeline_col2" data-aos="fade-right">
            <div class="data_pipeline_icon">
              <div class="data_pipeline_icon_bg">
          ...
          <div class="data_pipeline_col data_pipeline_col3" data-aos="fade-right">
            <div class="data_pipeline_icon">
              <div class="data_pipeline_icon_bg">
          ...
          <div class="data_pipeline_col data_pipeline_col4" data-aos="fade-right">
            <div class="data_pipeline_icon">
              <div class="data_pipeline_icon_bg">
          ...
          <div class="data_pipeline_col data_pipeline_col5" data-aos="fade-right">
            <div class="data_pipeline_icon">
              <div class="data_pipeline_icon_bg">
            ...
            <div id="service_carousel" class="service_carousel work_on_feature owl-carousel">
                <div class="service_column wow fadeInDown" data-wow-duration="2s">
                    <div class="service_column_bg">
                        ...
                        <p>Experience the artistry of our software development team as they craft bespoke solutions that align perfectly with your business objectives...</p>
                ...
                <div class="service_column wow fadeInDown" data-wow-duration="2.5s">
                    <div class="service_column_bg">
                        ...
                        <h3><a href="#">Artificial Intelligence & Block Chain </a></h3>
                            <p>Harness the transformative power of Artificial Intelligence (AI) and Block chain technologies to revolutionize your business landscape...</p>
                        <a href="#" class="learn_more_btn"><span>LEARN MORE</span></a>
                    </div>
                </div>
                <div class="service_column wow fadeInDown" data-wow-duration="2.8s">
                    <div class="service_column_bg">
                        ...
                        <p>Witness the seamless integration of human ingenuity and robotics as we redefine automation design, construction, and use of machines (robots) to...</p>
                        <a href="#" class="learn_more_btn"><span>LEARN MORE</span></a>
                    </div>
                </div>
                <div class="service_column wow fadeInDown" data-wow-duration="3s">
                    <div class="service_column_bg">
                        ...
                        <h3><a href="#">Collaboration Tools</a></h3>
                        <p>Maximize productivity and streamline collaboration with our cutting-edge Unified Communications (UC) and Workforce Management tools...</p>
                        <a href="#" class="learn_more_btn"><span>LEARN MORE</span></a>
                    </div>
                </div>
